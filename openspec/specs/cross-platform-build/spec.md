...
The build script and dependency/toolchain detection work identically on Linux, macOS, and Windows, so that `cargo build` succeeds on all three operating systems.
