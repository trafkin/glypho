{
  ...
  outputs = inputs: let
    ...
    in {inherit toolchain craneLib cargoRustFlags npmDeps pkgs;};
  ...
  in
    ...
    }
    {
      ...
      perSystem = {
        ...
        inherit (perSys.${system}) cargoRustFlags npmDeps;
      ...
      in {
        ...
        rust-project = {
          ...
          defaults.perCrate.crane.args = {
            ...
            nativeBuildInputs = lib.mkForce (with pkgs;
              ...
              ++ lib.optionals isLinux [mold llvmPackages.bintools]);
          };
        ...
        devShells.default = pkgs.mkShell (
          ...
          // lib.optionalAttrs isLinux {
            ...
            CARGO_BUILD_RUSTFLAGS = lib.concatStringsSep " " cargoRustFlags;
          }
        );
      };
    };
